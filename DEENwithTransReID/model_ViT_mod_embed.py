...
class TransReID(nn.Module):
    ...
    #              drop_path_rate=0., hybrid_backbone=None, norm_layer=nn.LayerNorm, local_feature=False):
        ...
        # cls_token不加modality embeddings
        ...
        # cls_token加上modality embeddings
        self.inf_modality_embed = nn.Parameter(torch.zeros(1, num_patches + 1, embed_dim))
        self.vis_modality_embed = nn.Parameter(torch.zeros(1, num_patches + 1, embed_dim))
