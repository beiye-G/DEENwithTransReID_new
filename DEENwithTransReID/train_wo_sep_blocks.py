...
from model_ViT_wo_sep_blocks import TransReID_SEP, vit_base_patch16_224_TransReID_SEP, vit_small_patch16_224_TransReID_SEP, deit_small_patch16_224_TransReID_SEP
from utils import *
...
suffix = dataset
suffix = suffix + '_llcm_lr__separate_wo_sep_blocks_{}_n{}_lr_{}_seed_{}'.format(args.num_pos, args.batch_size, args.lr, args.seed)
