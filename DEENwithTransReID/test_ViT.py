...
parser.add_argument('--resume', '-r', default='l/home/guohangyu/data/VIReID/DEENwithTransReID_new/DEENwithTransReID/save_model_bak/llcm_deen_p4_n6_lr_0.1_seed_0_best.t', type=str, help='resume from checkpoint')
