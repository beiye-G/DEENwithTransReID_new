...
from model_clip import VisionTransformer, vit_base_patch16_224_TransReID
from utils import *
...
suffix = suffix + '_cmtr_clip_stride16_p{}_n{}_lr_{}_seed_{}'.format(args.num_pos, args.batch_size, args.lr, args.seed)
...
# 加载预训练模型的参数
net.load_param('/home/guohangyu/data/checkpoints/clip_visual_B_16.pth')
net.to(device)
