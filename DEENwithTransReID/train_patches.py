...
from ViT_patches import TransReID, vit_base_patch16_224_TransReID, vit_small_patch16_224_TransReID, deit_small_patch16_224_TransReID
from utils import *
...
suffix = dataset
suffix = suffix + '_patches_cmtr_stride{}_p{}_n{}_lr_{}_seed_{}'.format(args.stride, args.num_pos, args.batch_size, args.lr, args.seed)
...
def train(epoch):
    ...
    for batch_idx, (input1, input2, label1, label2) in enumerate(trainloader):
        ...
        # loss = loss_id + loss_tri + loss_patches
        loss = loss_id + loss_tri + loss_patches
        optimizer.zero_grad()
        loss.backward()
        optimizer.step()
