...
from model_ViT_SSL_lam import TransReID, vit_base_patch16_224_TransReID, vit_small_patch16_224_TransReID, deit_small_patch16_224_TransReID
from utils import *
...
parser.add_argument('--lam', default=10, type=float, help='learning rate for TLoss')
...
suffix = suffix + '_SSL_lam{}_cmtr_stride16_p{}_n{}_lr_{}_seed_{}'.format(args.lam, args.num_pos, args.batch_size, args.lr, args.seed)
...
def train(epoch):
    ...
    for batch_idx, (input1, input2, label1, label2) in enumerate(trainloader):
        ...
        loss = loss_id + loss_tri/args.lam 
        optimizer.zero_grad()
        loss.backward()
        optimizer.step()
