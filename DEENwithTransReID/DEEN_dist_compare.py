...
parser.add_argument('--log_dist_path', default='log_dist_compare/', type=str, help='log save path')
...
batch = args.batch
if batch == 0:
    suffix = suffix + 'compare_' + 'all'
    path = suffix + '.json'
else:  
    suffix = suffix + 'compare_' + str(batch)
    path = suffix + '.json'
...
if dataset == 'llcm':
    ...
    for trial in range(10):
        ...
        # query_feat1 = query_feat1[:batch*args.test_batch]
        # query_feat2 = query_feat2[:batch*args.test_batch]
        # query_feat3 = query_feat3[:batch*args.test_batch]
        # query_feat4 = query_feat4[:batch*args.test_batch]
        # query_feat5 = query_feat5[:batch*args.test_batch]
        # query_feat6 = query_feat6[:batch*args.test_batch]
        # gall_feat1 = gall_feat1[:batch*args.test_batch]
        # gall_feat2 = gall_feat2[:batch*args.test_batch]
        # gall_feat3 = gall_feat3[:batch*args.test_batch]
        # gall_feat4 = gall_feat4[:batch*args.test_batch]
        # gall_feat5 = gall_feat5[:batch*args.test_batch]
        # gall_feat6 = gall_feat6[:batch*args.test_batch]
        ...
        # for i in range(batch*args.test_batch):
            ...
            for j in range(nquery+ngall):
                ...
                # if j < batch*args.test_batch:
                    ...
                    # gall_id = int(gall_label[j-batch*args.test_batch])
                    dist_2 = dist1[i][j]
        ...
        # for i in range(batch*args.test_batch):
            ...
            for j in range(nquery+ngall):
                ...
                # if j < batch*args.test_batch:
                    ...
                    gall_id_2 = gall_label[j-nquery]
                    # gall_id = int(gall_label[j-batch*args.test_batch])
                    # gall_cam = int(gall_cam[j-batch*args.test_batch])
                    dist_2 = dist1[i][j]
                    if query_id_tmp == gall_id_2 and dist_2 < dist_id_min:
                        dist_id_min = dist_2
